...
/**
 * @ORM\Entity(repositoryClass=EventGalRepository::class)
...
class EventGal
{
     ...
     *
     * @Vich\UploadableField(mapping="event_galery", fileNameProperty="imageName", size="imageSize")
     * @var File|null
     */
    private $imageFile;
    ...
    /**
     * @ORM\ManyToOne(targetEntity=Event::class, inversedBy="eventGals")
     */
    private $event;
